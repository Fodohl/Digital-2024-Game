...
namespace KinematicCharacterController.Examples
{
    ...
    {
        [HideInInspector]
        public InputSynchronizable inputs;
        ...
        private void Awake()
        {
            inputs = gameObject.GetComponent<InputSynchronizable>();
        ...
        /// </summary>
        public void SetInputs(ref PlayerCharacterInputs input)
        {
            // Clamp input
            Vector3 moveInputVector = Vector3.ClampMagnitude(new Vector3(inputs.AxesValues[0], 0f, inputs.AxesValues[1]), 1f);
