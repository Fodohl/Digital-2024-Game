...
public class GameManager : AttributesSync
{
    ...
    [SynchronizableField] public List<int> kills = new List<int>();
    [SynchronizableField] public List<int> deaths = new List<int>();
    ...
    public void OnOtherUserJoined(Multiplayer multiplayer, User user){
        if(kills.Count < user.Index)
        {
            kills.Add(0);
        }
        if(deaths.Count < user.Index)
        {
            deaths.Add(0);
        }
    }
