...
public class GameManager : AttributesSync
{
    ...
    [SynchronizableField] public Dictionary< int, int> kills = new Dictionary<string, int>();
    [SynchronizableField] public Dictionary< int, int> deaths = new Dictionary<string, int>();
    ...
    public UnityEvent OnRoomJoined(Multiplayer multiplayer, Room room, User user){
