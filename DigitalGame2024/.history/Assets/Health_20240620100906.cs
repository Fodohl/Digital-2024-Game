...
public class Health : AttributesSync {
    ...
    private void Die(User enemyUser){
        GameManager.Instance.AddKills(enemyUser);
        GameManager.Instance.DestroyAvatar(Multiplayer.GetUser(gameObject.GetComponent<Alteruna.Avatar>().name), gameObject.name);
